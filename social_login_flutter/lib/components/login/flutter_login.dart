...
import 'package:social_login_flitter/components/login/providers/auth.dart';
import 'package:social_login_flitter/components/login/providers/login_messages.dart';
import 'package:social_login_flitter/components/login/providers/login_theme.dart';
import 'package:social_login_flitter/components/login/widgets/auth_card.dart';
import 'package:social_login_flitter/components/login/widgets/fade_in.dart';
import 'package:social_login_flitter/components/login/widgets/gradient_box.dart';
import 'package:social_login_flitter/components/login/widgets/hero_text.dart';
import 'package:social_login_flitter/components/login/widgets/null_widget.dart';
import 'package:social_login_flitter/helper/color_helper.dart';
import 'package:social_login_flitter/helper/dart_helper.dart';
import 'package:social_login_flitter/helper/regex.dart';
...
class __HeaderState extends State<_Header> {
  ...
  Widget build(BuildContext context) {
    ...
    const gap = 5.0;
    final logoHeight =
        min(widget.height - _titleHeight - gap, kMaxLogoHeight) - 20;
