...
import 'package:social_login_flitter/helper/matrix.dart';
import 'package:social_login_flitter/helper/paddings.dart';
import 'package:social_login_flitter/helper/widget_helper.dart';
import 'package:social_login_flitter/models/login_data.dart';
...
class _LoginCardState extends State<_LoginCard> with TickerProviderStateMixin {
  ...
  Widget _buildPasswordField(double width, LoginMessages messages, Auth auth) {
    return AnimatedPasswordTextFormField(
      ...
      textInputAction:
          auth.isLogin ? TextInputAction.done : TextInputAction.done,
  ...
  Widget _buildSwitchAuthButton(
    ...
    return FadeIn(
      ...
      child: FlatButton(
          ...
          textColor: kAppMainColor //theme.primaryColor,
          ),
    );
  }
